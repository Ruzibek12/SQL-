Ruzibek Kurbonov, [9/27/2025 9:19 AM]
...
values
(1,'Ali','Bal',34,5600), 
(2,'Bob','Heylie',41,7000), 
(3,'Matt','Bob',39,3900); 

select * from Employees

select FirstName as Name, Lastname as Surname, Salary as Payment
...
SELECT 
    ...
    IIF(StockQuantity > 100, 'yes',
        IIF(StockQuantity < 100, 'no', 'else')
    ) AS Stock_quantity_status 
FROM Products;
